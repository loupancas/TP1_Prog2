...
public class LifeEnemy : MonoBehaviour
{
    ...
    public float danoCritico;// se personaliza el dano critico seg�n la vida total del enemigo
    ...
    public void golpe(int damageRecibido) // en cada golpe se ir� perdiendo vida hasta que finalmente el enemigo se destruye , esto es una funcion publica
    {
